...
This chapter turns to the \key{synthetic} direction of the interconnection between internalism and externalism. \todo{analytic direction}
...
\hskip\mathindent & |geq • fun length-alg| &
\end{flalign*}
Note that these calculations are good illustrations of the power of relational calculation because of their simplicity --- they are straightforward symbolic manipulations, hiding details like quantifier reasoning behind the scenes.
