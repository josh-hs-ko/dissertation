...
%format := = "{\protect\raisebox{.08pt}{\ensuremath{\mathop:}}\shorteq}"
...
%format offers = "\ni"
%format noffers = "\mathrel{\rlap{\kern-.06em\ensuremath{\not}}{\ni}}"
...
%format _×'_ = _ "{\smash{\dot\times}}\kern-\underscorespace" _
%format inj₁ = "\constructor{inl}"
%format inj₂ = "\constructor{inr}"
%format ▿ =  "\triangledown"
%format _▿_ =  _ "{" ▿ "}\kern-\underscorespace" _
%link ▿ _▿_
%format ▵ =  "\protect\rotatebox[origin=c]{180}{\ensuremath{" ▿ "}}"
%link _▵_ _▵
%format _▵_ = _ "{" ▵ "}\kern-\underscorespace" _
%format _*_ = _ "{" * "}\kern-\underscorespace" _
%link * _*_
...
%format _/_ = _ "{\protect\raisebox{-1pt}{\protect\scalebox{1.1}{/}}}\kern-\underscorespace" _
...
%format Refinement'.P = Refinement "\rlap{\ensuremath{^\prime}}\kern.5pt\recordmember\kern.5pt" P
%format Refinement'.forget = Refinement "\rlap{\ensuremath{^\prime}}\kern.5pt\recordmember\kern.5pt" forget
%format Refinement'.p = Refinement "\rlap{\ensuremath{^\prime}}\kern.5pt\recordmember\kern.5pt" p
...
%format ∇ = "\protect\rotatebox[origin=c]{180}{\ensuremath{" Δ "}}"
...
%format ⌊_⌋ = "\protect\lfloor" _ "\kern\underscorespace\protect\rfloor"
%format ⌈_⌉ = "\protect\lceil" _ "\kern\underscorespace\protect\rceil"
...
%format _>>=_ = _ "{" >>= "}\kern-\underscorespace" _
%link >>= _>>=_
%format <$> = "\mathop{\protect\raisebox{2.4pt}{\protect\scalebox{1}[.4]{\ensuremath{\protect\langle}}}\$\protect\raisebox{2.4pt}{\protect\scalebox{1}[.4]{\ensuremath{\protect\rangle}}}}"
%link <$> _<$>
%format _<$> = _ "{" <$> "}"
%format <$>² = "\mathop{{" <$> "}\kern-.5pt^2}"
%link <$>² _<$>²
%format _<$>² = _ "{" <$>² "}"
%format • = "\mathop{\protect\raisebox{2pt}{\protect\scalebox{0.5}{\ensuremath{\bullet}}}}"
%link • _•_
...
%format toBin-mapBHeap = "\identifier{toBin\text-mapBHeap}"
%format shift-halve-coherence = "\identifier{shift\text-halve\text-coherence}"
