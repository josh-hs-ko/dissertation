...
The idea of viewing vectors as promotion predicates was first proposed by \citet[page~82]{Bernardy-thesis}, and is later generalised to ``type theory in color''~\citep{Bernardy-color}, which uses modalities inspired by colors in typing to manage relative irrelevance of terms and erasure of irrelevant terms.
