...
\todo[inline]{emphasise that the advent of interactive development helps dealing with detail}
...
Universes can encode such shapes, and since universes are just ordinary sets, datatype-generic programming becomes just ordinary programming in dependently typed languages~\citep{Altenkirch-GP-within-DTP}.\todo{even more generalised}
...
\todo[inline]{emphasise the role of inductive families}
