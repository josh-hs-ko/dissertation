...
\end{code}
In general, however, inductive families are strictly more expressive than recursive families:
with recursive families, the index in the type of a sub-object has to be structurally smaller, whereas inductive families do not have this restriction.
