...
\newcommand{\arXiv}[1]{arXiv:\href{http://arxiv.org/abs/#1}{\nolinkurl{#1}}}
...
\def\endofblock{%   
   % according to the TeX book, at the end of Chapter 14:
   \unskip\nobreak\hfill\penalty50
   \hskip1em\hbox{}\hfill\endofblockmark
   \parfillskip=0pt\finalhyphendemerits=0}
\def\endofblockmark{$\Box$}
\makeatletter
\def\block{\@ifstar\@block\@@block}
\newcommand{\@block}[2]{\begingroup\noindent\textbf{#1.}\hskip1em #2\endofblock\endgroup} % \hskip1em(\textit{End of \lowercase{#1}}.)
\newcommand{\@@block}[3]{\begingroup\noindent\textbf{#1}~(\nobreak\hskip.05em\nobreak\textit{#2}\nobreak\hskip.05em\nobreak)\textbf.\hskip1em #3\endofblock\endgroup}
\makeatother
