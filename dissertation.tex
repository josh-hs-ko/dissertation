...
\usepackage[a4paper,scale=.7,hcentering]{geometry}
...
\usepackage[bookmarksnumbered,hidelinks,hyperindex,backref=page]{hyperref}
\hypersetup{%
  pdftitle={Analysis and synthesis of inductive families},%
  pdfauthor={Hsiang-Shang Ko},%
  pdfsubject={DPhil dissertation},%
  pdfkeywords={dependent types, inductive families, datatype ornamentation}}
...
\renewcommand*{\backrefalt}[4]{%
  ...
  \fi}
\urlstyle{tt}
\newcommand{\doi}[1]{{\small DOI}:~\href{https://doi.org/#1}{\nolinkurl{#1}}}
...
\newgeometry{scale=.7,top=3.5cm,hcentering}
\subfile{abstract}
\cleardoublepage
\restoregeometry
