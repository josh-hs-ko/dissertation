...
One ad hoc way to achieve this in Agda's intensional setting is to use \emph{setoids}~\citep{Barthe-setoids} --- sets with an explicitly specified equivalence relation --- to represent sets of morphisms.
